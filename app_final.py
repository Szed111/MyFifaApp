                ...
                [
                    ...
                    dbc.Col(
                        [#html.Label("FOOTBALL PLAYER GENERATIONS",id = "label1"),
                         html.Label("FOOTBALL PLAYER ANALYSIS AND VISUALIZATION",id = "label1"),
                         html.Label("Explore the differences between old-school and new talents",className = "label2"),
                         html.Br(),
                        #  html.Label("Dashboard created by: Catarina Pinheiro, Henrique Renda, Nguyen Phuc, Lorenzo Pigozzi",className = "label2",style={'margin-bottom':'.34rem'})
                        ],width=8)
                ],
                align="between",
                #no_gutters=True,
...
app.layout = dbc.Container([
        ...
        dbc.Tabs(
            [
                ...
                # dbc.Tab(tab3_content, label="Live Score"),
            ], 
        ),
    ],
    fluid=True,
